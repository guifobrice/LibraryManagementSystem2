...
import com.codewithbrice.librarymanagementsystem.configurations.JwtProvider;
...
import com.codewithbrice.librarymanagementsystem.modal.PasswordResetToken;
...
import com.codewithbrice.librarymanagementsystem.repository.PasswordResetTokenRepository;
...
//        String role = authorities.iterator().next().getAuthority();
    ...
    @Transactional
    public void createdPasswordResetToken(String email) throws UserException {
        ...
        PasswordResetToken resetToken = PasswordResetToken.builder()
                .token(token)
                .user(user)
                .expiryDate(LocalDateTime.now().plusMinutes(120))
                .build();
