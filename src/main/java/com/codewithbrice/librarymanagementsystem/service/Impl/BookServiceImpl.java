...
import com.codewithbrice.librarymanagementsystem.mapper.BookMapper;
...
import com.codewithbrice.librarymanagementsystem.repository.BookRepository;
...
public class BookServiceImpl implements BookService {
    ...
    public PageResponse<BookDTO> searchBooksWithFilters(BookSearchRequest searchRequest) {
        ...
        String keyword = searchRequest.getSearchTerm();
        if(keyword == null || keyword.isBlank()) {
            keyword = "";
        }
        Page<Book> bookPage1 = bookRepository.searchBooksWithFilters(
                keyword,
                searchRequest.getGenreId(),
                searchRequest.getAvailableOnly(),
                pageable
        ...
        return convertToPageResponse(bookPage1);
    }
