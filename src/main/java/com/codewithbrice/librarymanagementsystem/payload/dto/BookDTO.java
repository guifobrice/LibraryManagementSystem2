...
public class BookDTO {
    ...
    @Digits(integer = 8, fraction=2, message = "Price must have at most 8 integer digits and cannot be negative")
    private BigDecimal price;

    @Size(max=500, message="Imag URL must not exceed 500 characters")
